...
module.exports = NodeHelper.create({
	...
	executeQuery: function(query, res) {
		...
		{
			console.log("before");
			exec('sudo python3 /home/pi/LED_New.py');
			console.log("After");
			return true;
		}
...
// create all the edit modules/ HUANG KAI ADDED FEB 1
var moduleElement;

if(moduleData[i].identifier!="module_5_compliments"){
			...
			moduleElement =
				...
				moduleElement =
				'<div id="' + moduleData[i].identifier + '" class="menu-element button edit-button edit-menu toggled-off">\n' +
					'<span class="stack fa-fw">\n' +
						'<span class="fa fa-fw fa-toggle-on outer-label fa-stack-1x" aria-hidden="true"></span>\n' +
						'<span class="fa fa-fw fa-toggle-off outer-label fa-stack-1x" aria-hidden="true"></span>\n' +
						'<span class="fa fa-fw fa-lock inner-small-label fa-stack-1x" aria-hidden="true"></span>\n' +
