...
Module.register("newsfeed",{
	...
	getDom: function() {
		...
		// NewsItems here are the news items
		...
		if (this.newsItems.length > 0) {
			...
			// Here are the necessary CSS headers
			// I added marquee
			var title = document.createElement("div");
			title.className = "bright medium light";
			// I changed here
			title.innerHTML = '<marquee behavior="scroll" direction="left">' + this.newsItems[this.activeItem].title + '</marquee>';
			wrapper.appendChild(title);
				
			if (this.config.showDescription) {
				var description = document.createElement("div");
				description.className = "small light";
				description.innerHTML = '<marquee behavior="scroll" direction="left">' + this.newsItems[this.activeItem].description + '</marquee>';
